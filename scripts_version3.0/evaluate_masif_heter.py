...
predicted_rr_dir='./masif_heter_predictions_rr/'
...
pdb_name_file="cd-hit-pdb_heter_list.txt"
...
#	true_image_name=os.path.join('/home/huanghe/huangh/GAN-collection/image-inpainting/Inpainting/workspace_3_19/true_dir',name+'.txt')
	output_image_name=os.path.join(output_dir,name_img+'.jpg')
...
#	true_sub_matrix=true_sub_matrix/255.0
	true_sub_matrix[true_sub_matrix<6]=1
	true_sub_matrix[true_sub_matrix>=6]=0
