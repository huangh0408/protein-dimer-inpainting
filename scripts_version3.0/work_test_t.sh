##test masif
CUDA_VISIBLE_DEVICES="4" python test_test.py  --input_dir /extendplus/huanghe/dimer_workspace/data_version_2.0/datasets/masif_homodimers/ --type=homodimer --mode contact --netsize 256 --batch_size 582
...
CUDA_VISIBLE_DEVICES="4" python test_val.py  --input_dir /extendplus/huanghe/dimer_workspace/data_version_2.0/datasets/3dcomplex_homodimers --type=homodimer --mode contact --netsize 256 --batch_size 582
...
CUDA_VISIBLE_DEVICES="4" python test_train.py  --input_dir /extendplus/huanghe/dimer_workspace/data_version_2.0/datasets/3dcomplex_homodimers --type=homodimer --mode contact --netsize 256 --batch_size 582
python evaluate.py --ground_truth_dir /extendplus/huanghe/dimer_workspace/data_version_2.0/groundtruth/3dcomplex_homodimers --type=homodimer --mode contact --netsize 256
...
#mv ./results/test* ./test_train
##test capri
CUDA_VISIBLE_DEVICES="4" python test_test.py  --input_dir /extendplus/huanghe/dimer_workspace/data_version_2.0/datasets/casp-capri-12-13-14/ --type=homodimer --mode contact --netsize 256 --batch_size 40
...
echo "test capri"
CUDA_VISIBLE_DEVICES="4" python test_test.py  --input_dir /extendplus/huanghe/dimer_workspace/data_version_2.0/datasets/gremlin/ --type=homodimer --mode contact --netsize 256 --batch_size 32
...
echo "test gremlin"
CUDA_VISIBLE_DEVICES="4" python test_test.py  --input_dir /extendplus/huanghe/dimer_workspace/data_version_2.0/datasets/benchmark5-bound/ --type=homodimer --mode contact --netsize 256 --batch_size 118
