...
def draw_image(name_list):
	...
	for line in lines:
		line=line.strip("\n")
		name=line.split(".")[0]
		jpgname=os.path.join('./jpg_test/',name+'.png')
#		fig,axes=plt.subplots(nrows=1,ncols=2,figsize=(12,5))
		true_dir=os.path.join('/extendplus/huanghe/dimer_workspace/data_version_2.0/groundtruth/masif_homodimers/matrix',name+'.txt')
		true_multi_dir=os.path.join('/extendplus/huanghe/dimer_workspace/data_version_2.0/groundtruth/masif_homodimers/matrix',name+'.txt')
		pred_dir=os.path.join('./test_test/images_with_input/',name+'.jpg')
		length_dir=os.path.join('/extendplus/huanghe/dimer_workspace/data_version_2.0/groundtruth/masif_homodimers/length',name+'.txt')
...
#		fig,axes=plt.subplots(nrows=1,ncols=2,figsize=(12,5))
		...
		figure4_matrix[figure4_matrix<=12]=1
		figure4_matrix[figure4_matrix>12]=0
...
if __name__=="__main__":
	draw_image(name_list="pdb_list_test.txt")
