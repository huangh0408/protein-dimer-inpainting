...
adversarial_pos = model.build_adversarial_temp(images_hiding,net_size, is_train)
adversarial_neg = model.build_adversarial_temp(reconstruction, net_size,is_train, reuse=True)
