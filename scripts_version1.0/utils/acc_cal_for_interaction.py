...
def evaluate_temp(predict_matrix, contact_matrix):
   ...
   # contact_matrix[contact_matrix>8]=0
    acc_k_1 = topKaccuracy_temp(predict_matrix, contact_matrix, 1)
    acc_k_2 = topKaccuracy_temp(predict_matrix, contact_matrix, 2)
    acc_k_5 = topKaccuracy_temp(predict_matrix, contact_matrix, 5)
    acc_k_10 = topKaccuracy_temp(predict_matrix, contact_matrix, 10)
