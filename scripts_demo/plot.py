...
#		fig,axes=plt.subplots(nrows=1,ncols=2,figsize=(12,5))
		true_dir=os.path.join('/extendplus/huanghe/dimer_workspace/data_version_2.0/groundtruth/contact/matrix',name+'.txt')
		true_multi_dir=os.path.join('/extendplus/huanghe/dimer_workspace/data_version_2.0/groundtruth/contact/matrix',name+'.txt')
		pred_dir=os.path.join('results/test_contact_256/images_with_input/',name+'.jpg')
		length_dir=os.path.join('/extendplus/huanghe/dimer_workspace/data_version_2.0/groundtruth/contact/length',name+'.txt')
...
if __name__=="__main__":
	draw_image(name_list="testing_list_masif_homodimer.txt")
