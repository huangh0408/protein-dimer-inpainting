...
#            return s
    ...
    def build_reconstruction_128(self, images,images_global,is_train):
...
#        return bn1, bn2, bn3, bn4, bn5, bn6, debn4, debn3, debn2, debn1, recon, tf.nn.tanh(recon)
    ...
    def build_reconstruction_256(self, images,images_global,is_train):
        batch_size = images.get_shape().as_list()[0]
        ...
        with tf.variable_scope('GEN'):
            ...
            recon = self.new_deconv_layer( debn0, [4,4,3,64], [batch_size,128,128,3], stride=2, name="recon-256")
        return bn1, bn2, bn3, bn4, bn5, bn6, debn4, debn3, debn2, debn1, recon, tf.nn.sigmoid(recon)
